...
public class MemberController extends BaseController {
    ...
    public ResponseEntity<?> signUp(@RequestBody Member member) {
        ...
        MemberAuth memberSignUp = memberService.create(member);
        return ResponseEntity.ok(memberSignUp);
    }
...
//    }
    ...
    public ResponseEntity<?> update(@PathVariable String Email, @RequestBody Member member) {
        ...
        log.info("update: Email={}, member={}", Email, member.toString());
    ...
    public ResponseEntity<?> delete(@PathVariable String Email) {
        ...
        // 2. Business Logic
        int deletedCount = memberService.delete(Email);
